...
def p_package_1(p):
    ...
    p[0] = ('package', p[2], 'no version', p[4])

def p_package_2(p):
    'package : PACKAGE name version LBRACE userTypes RBRACE'
    p[0] = ('package', p[2], p[3], p[5])
...
def p_method(p):
    ...
    p[0] = 'method', p[2], p[3], p[1], p[5], p[7], p[8], p[10], p[11]
